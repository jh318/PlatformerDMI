...
<tileset name="CloudBG2" tilewidth="64" tileheight="64" tilecount="18" columns="6">
 <image source="../PNGs/CloudTileGimp2.png" width="384" height="192"/>
 <terraintypes>
  <terrain name="Cloud" tile="4"/>
 </terraintypes>
 <tile id="0" terrain=",,,0"/>
